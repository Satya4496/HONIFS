...
/**
 * @deprecated This screen is deprecated. We using authorization code flow now.
 */
    ...
    <Center flex={0.6} px="3">
      ...
      <Box
        ...
        <FormControl isRequired my="2">
          <Stack mx="4">
            <FormControl.Label>{i18n.t('AbpAccount::UserNameOrEmailAddress')}</FormControl.Label>
            <Input
        ...
        <FormControl isRequired my="2">
          <Stack mx="4">
            <FormControl.Label>{i18n.t('AbpAccount::Password')}</FormControl.Label>
            <Input
              type="password"
